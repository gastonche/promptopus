...
- **`llama-3.1-8b` is the sweet spot** — 99% pass, perfect faithfulness *and* quality, ~$0.0003, sub-second
...
- **Reasoning models are the wrong tool** — `qwq-32b` cratered at **39%**. Its output is pure
  chain-of-thought (*"Okay, the user wants a summary… Let me read through…"*), caught at once by length,
